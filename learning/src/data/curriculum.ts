...
export const curriculum: Category[] = [
  {
    ...
    topics: [
      ...
      { id: 'electric-charge', title: '2. Electric Charge', isImplemented: true },
      { id: 'electrons', title: '3. Electrons', isImplemented: true },
      { id: 'conductors-insulators', title: '4. Conductors and Insulators', isImplemented: true },
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'open-closed-circuit', title: '17. Open vs Closed Circuit', isImplemented: true },
      { id: 'circuit-paths', title: '18. Circuit Paths', isImplemented: true },
      { id: 'circuit-symbols', title: '19. Circuit Symbols', isImplemented: true },
      { id: 'reading-schematics', title: '20. Reading Schematics', isImplemented: true },
      ...
      { id: 'series-parallel', title: '23. Series-Parallel Circuits', isImplemented: true },
      { id: 'voltage-drop', title: '24. Voltage Drop', isImplemented: true },
      { id: 'voltage-division', title: '25. Voltage Division', isImplemented: true },
      { id: 'current-division', title: '26. Current Division', isImplemented: true },
      { id: 'kcl', title: '27. Kirchhoff\'s Current Law', isImplemented: true },
      { id: 'kvl', title: '28. Kirchhoff\'s Voltage Law', isImplemented: true },
      { id: 'equivalent-resistance', title: '29. Equivalent Resistance', isImplemented: true },
      { id: 'circuit-analysis', title: '30. Circuit Analysis Basics', isImplemented: true }
    ]
  },
  {
    ...
    topics: [
      { id: 'resistors', title: '31. Resistors', isImplemented: true },
      { id: 'resistor-color-codes', title: '32. Resistor Color Codes', isImplemented: true },
      { id: 'resistor-tolerance', title: '33. Resistor Tolerance', isImplemented: true },
      { id: 'resistor-power', title: '34. Resistor Power Rating' },
      { id: 'resistor-power', title: '34. Resistor Power Rating', isImplemented: true },
      { id: 'potentiometers', title: '35. Potentiometers', isImplemented: true },
      { id: 'capacitors', title: '36. Capacitors', isImplemented: true },
      { id: 'capacitor-polarity', title: '37. Capacitor Polarity', isImplemented: true },
      { id: 'capacitor-charging', title: '38. Capacitor Charging', isImplemented: true },
      { id: 'capacitor-discharging', title: '39. Capacitor Discharging', isImplemented: true },
      { id: 'rc-time-constant', title: '40. RC Time Constant', isImplemented: true },
      { id: 'inductors', title: '41. Inductors', isImplemented: true },
      { id: 'diodes', title: '42. Diodes', isImplemented: true },
      { id: 'diode-polarity', title: '43. Diode Polarity', isImplemented: true },
      { id: 'forward-bias', title: '44. Forward Bias', isImplemented: true },
      { id: 'reverse-bias', title: '45. Reverse Bias', isImplemented: true },
      { id: 'zener-diodes', title: '46. Zener Diodes' },
      { id: 'leds', title: '47. LEDs', isImplemented: true },
      { id: 'switches', title: '48. Switches', isImplemented: true },
